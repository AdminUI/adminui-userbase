<template>
    <section class="container-fluid mt-4">
        <div class="row">
            <div class="col-12">
                <p>Use the below form to request return authorisation from {{ siteName }}.</p>
            </div>
            <div class="col-12">
                <vue-form v-model:isValid="returnForm.isValid" @submit="doSendReturn">
                    ...
                    <div class="d-flex justify-content-end">
                        <vue-button tile :background="colours.primary" type="submit">Send Returns Request</vue-button>
                    </div>
                </vue-form>
            </div>
        </div>
